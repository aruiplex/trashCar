...
def pid_move(angle, distance, orientation):
    ...
    Size is the c returned by calSize function
    Angle is the motion direction angle in radian, 0 at forward direction (posotive y-axis), positive for counter-clockwise
    Distance is the absolute length for moving. If distance == 0, the car rotates in z-axis
    Orientation is the angle of the head of the car in radian, same direction with angle
    """
    dis = distance * 2000 / 25  # Convert the distance into cycles
