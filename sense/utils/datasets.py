...
from sense.utils.general import check_requirements, check_file, check_dataset, xywh2xyxy, xywhn2xyxy, xyxy2xywhn, \
    xyn2xy, segment2box, segments2boxes, resample_segments, clean_str
from sense.utils.torch_utils import torch_distributed_zero_first
    ...
    def __getitem__(self, index):
        ...
        if nL:
            ...
            labels[:, 1:5] = xyxy2xywhn(
                labels[:, 1:5], w=img.shape[1], h=img.shape[0])
